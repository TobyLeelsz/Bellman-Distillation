...
EVAL_DATA_DIR="${BASE_PATH}/data/dolly"
# hp
GRAD_ACC=16
BATCH_SIZE=1
CHUNK_SIZE=8
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/bellman/train.py ${OPTS} $@"
